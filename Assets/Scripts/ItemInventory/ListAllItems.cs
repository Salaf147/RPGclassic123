...
public class ListAllItems : MonoBehaviour
{
    ...
    //chet du so luong qua man
    public int demsoquaichet;
    ...
    public void checksoluongenemychet() 
    {
        Debug.Log("1 con enemy chet");
        demsoquaichet++;
        if (demsoquaichet >= 10) 
        { 
        //qua man o day so 10 la dieu kien con quai chet +1 
        }
    }
    private void Start()
    {
